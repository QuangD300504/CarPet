...
private fun InfoRow(label: String, value: String) {
    Row(
        ...
        Text(text = label, fontSize = 14.sp, fontWeight = FontWeight.Medium, color = Color.Black.copy(alpha = 1f))
        Text(text = value, fontSize = 14.sp, fontWeight = FontWeight.Normal, color = Color.Gray.copy(alpha = 1f))
    }
}

@Composable
private fun VaccinationItem(title: String, isCompleted: Boolean, date: String? = null) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .background(
        ...
        Column(modifier = Modifier.weight(1f)) {
            Text(text = title, fontSize = 14.sp, fontWeight = FontWeight.Medium, color = Color.Black.copy(alpha = 1f))
            if (date != null) {
                Text(text = date, fontSize = 12.sp, color = Color.Gray.copy(alpha = 1f), modifier = Modifier.padding(top = 4.dp))
            }
        }
        Text(
